 ...
 * Generally, it will be initialized by loading the metadata file from disk.
 */
public class IdPConfig {

    /**
     * Default constructor. Applications may use this if the configuration information comes from some outside source.
     */
    public IdPConfig() {
    }
...
//                        break find_cert_loop;
    ...
    /**
     * Certificates used to validate assertions
     */
    ...
    /**
     * Set the IdP login URL. The login URL is where the user is redirected from the SP to initiate the authentication
     * process.
     */
    ...
    /**
     * Set the IdP public key certificate. The certificate is used to validate signatures in the assertion.
     */
    ...
    /**
     * Get the Idp public key certificates.
     */
